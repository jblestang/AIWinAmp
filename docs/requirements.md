...
| R6 | The project shall bundle at least one sample audio track and provide a documented way to add custom assets, including MP3/FLAC/OGG/WAV/AAC ingestion. | Must | Documentation Review + manual import smoke test | Verified via README “Importing Audio” and Symphonia-backed importer. |
